...
public class OpenWeathermap {
    ...
    public void RegistrationSuccessful()
    {
        ...
        Assert.assertEquals( "Operation completed successfully", response.jsonPath().get("Message"), "Correct Success code was returned");
    ...
    @Test
    public void RegistrationSuccessfulTwo()
    {
